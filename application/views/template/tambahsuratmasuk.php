		...
		<div class="row-fluid">
			...
			<div>
				<ul class="breadcrumb">
					...
					<li>
                                            <a href="<?php echo base_url();?>index.php/surat_masuk">Surat Masuk</a> <span class="divider">/</span>
					</li>
                                        <li>
						<a href="<?php echo base_url();?>index.php/surat_masuk/tambah">Tambah</a>
					</li>
				</ul>
			</div>
			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-mail-alt"></i>  <?php 
                                                if (empty($isi)){
                                                    
                                                }else{
                                                echo "DETIL ".$isi->judul;
					...
					<div class="box-content">
						  ...
						  <fieldset>
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								<input type="text" class="span6 typeahead" name="judul"  >
							  ...
							  <div class="controls">
								<input type="text" class="span6 typeahead" name="no_surat"  >
