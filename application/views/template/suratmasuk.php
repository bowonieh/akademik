		...
		<div class="row-fluid">
			...
			<div class="span2 main-menu-span">
				<div class="well nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a class="ajax-link" href="<?php echo base_url();?>index.php/surat_masuk"><i class="icon-eye-open"></i><span class="hidden-tablet"> Surat Masuk</span></a></li>
						<li><a class="ajax-link" href="<?php echo base_url();?>index.php/surat_keluar"><i class="icon-edit"></i><span class="hidden-tablet"> Surat Keluar</span></a></li>
			...
			<div>
				<ul class="breadcrumb">
					...
					<li>
						<a href="<?php echo base_url();?>index.php/surat_masuk">Surat Masuk</a>
					</li>
				</ul>
			</div>
