			...
			<div class="container-fluid">
				...
				<div class="btn-group pull-right" >
					...
					<ul class="dropdown-menu">
						...
						<li class="divider"></li>
						<li><a href="<?php echo base_url();?>index.php/keluar">Logout</a></li>
					</ul>
				</div>
				<!-- user dropdown ends -->
	...
	<!-- topbar ends -->
		...
		<div class="row-fluid">
			...
			<div class="sortable row-fluid">
				<a data-rel="tooltip" title="<?php echo $suratmasuk;?> Surat Masuk." class="well span3 top-block" href="#">
					<span class="icon32 icon-red icon-mail-closed"></span>
					<div>Total Surat Masuk</div>
					<div><?php echo $suratmasuk;?></div>
					<span class="notification"><?php echo $suratmasuk;?></span>
				</a>

				<a data-rel="tooltip" title="<?php echo $suratkeluar;?> Surat Keluar." class="well span3 top-block" href="#">
					<span class="icon32 icon-color icon-star-on"></span>
					<div>Total Surat Keluar</div>
					<div><?php echo $suratkeluar;?></div>
					<span class="notification green"><?php echo $suratkeluar;?></span>
				</a>
<!--
			...
			<div class="row-fluid sortable">
				...
				<div class="box span4">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-list-alt"></i> Surat Masuk terkini</h2>
						<div class="box-icon">
							<a href="#" class="btn btn-minimize btn-round"><i class="icon-chevron-up"></i></a>
							<a href="#" class="btn btn-close btn-round"><i class="icon-remove"></i></a>
						</div>
					...
					<div class="box-content">
						<div class="box-content">
							<ul class="dashboard-list">
                                                            <?php foreach ($smterkini as $d){
                                                              ?>
                                                            <li>
									<a href="#">
										<img class="dashboard-avatar" alt="Usman" src="http://www.gravatar.com/avatar/f0ea51fa1e4fae92608d8affee12f67b.png?s=50"></a>
										<strong>Pengirim:</strong> <a href="#"><?php echo $d->pengirim;?>
									</a><br>
									<strong>Tanggal:</strong> <?php echo $d->tanggal;?><br>
