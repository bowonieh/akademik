...
<!-- header -->
  ...
  <div id="kontenbody">
   ...
   <div class="map">Pesan > Kotak Masuk
   ...
   <div class="span8">  
       ...
       <table class="table table-condensed table-hover bootstrap-datatable datatable pesanMasuk " id="pesanMasuk">
        <thead>
          <tr>
          <th>
          Pengirim
          ...
          if (empty($list)){
            ...
            foreach($list as $d){
              ...
              <?php 
              	if($d->sudah_dibaca=== 'y'){
				?>
              		<tr class=sudahDibaca>
              		<td>
              		PENGIRIM
              		</td>
              		<td>
              		<?php echo $d->judul ."-". $d->pesan; ?>
              		</td>
              		<td>
              		Tanggal
              		</td>
