...
<!-- header -->
  ...
  <div id="kontenbody">
   ...
   <p class="nama"><?php echo strtoupper($namasiswa->nama_siswa);?></p>
   
   <div class="judul">INFORMASI TERBARU</div>
   <div class="hrnya"></div>
   

   <p class="judul_info">JADWAL UN TAHUN AJARAN 2014</p>
   <p class="isi_info">orem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
   <p class="waktu_info">Jan, 02 2014 - 12:00 WIB</p>
