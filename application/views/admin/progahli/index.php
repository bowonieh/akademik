...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var no = 1;
        $('#progAhliContainer').jtable({
            title: 'KOMPETENSI KEAHLIAN',
            
            actions: {
                listAction: '<?php echo base_url();?>index.php/progahli/ambil',
                createAction: '<?php echo base_url();?>index.php/progahli/create',
                updateAction: '<?php echo base_url();?>index.php/progahli/update',
                deleteAction: '<?php echo base_url();?>index.php/progahli/delete'
            },
            fields: {
                id_prog_ahli: {
                    key: true,
                ...
                kode_kk:{
                title:'KODE KOMPETENSI KEAHLIAN',
                width:'40%'
                },
                nama_prog_ahli: {
                    title: 'NAMA KOMPETENSI KEAHLIAN',
                    width: '40%'
                }
                
            }
        });
        $('#progAhliContainer').jtable('load');
    });
</script>
</html>
