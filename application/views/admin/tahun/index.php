			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header well" data-original-title>
						...
						<div class="box-icon">
                                                        <a href="<?php echo base_url();?>index.php/tahun/tambah" class="btn btn-round"><i class="icon-plus"></i> </a>
						  ...
						  <tbody>
                                                      ...
                                                      <tr>
                                                          ...
                                                          <td class="center">
                                                              ...
                                                              <a data-toggle="modal" href="#" data-href="<?php echo base_url();?>index.php/tahun/viewdetil/<?php echo $d->id_tahun;?>" class="btn btn-primary">Lihat</a>
									...
									<a class="btn btn-danger delete" href="<?php echo base_url();?>index.php/tahun/hapus/<?php echo $d->id_tahun;?>" data-confirm="Hapus Data?">
