			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-mail-alt"></i> DATA GURU</h2>
						<div class="box-icon">
						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <tbody>
                                                      ...
                                                      <tr>
                                                          ...
                                                          <td class="center"><?php echo $d->nik;?></td>
                                                          <td class="center"><?php echo $d->tempat;?> , <?php echo $d->tgl_lahir;?></td>
                                                          <td class="center">
                                                              
                                                              <a data-toggle="modal" href="#" data-href="<?php echo base_url();?>index.php/guru/detil/<?php echo $d->id_guru;?>" class="btn btn-primary">Lihat</a>

									<a class="btn btn-info" href="#">
										<i class="icon-edit icon-white"></i>  
										Edit                                            
									</a>
									<a class="btn btn-danger delete" href="<?php echo base_url();?>index.php/guru/hapus/<?php echo $d->id_guru;?>" data-confirm="Hapus Data?">
