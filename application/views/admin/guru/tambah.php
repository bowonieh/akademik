				...
				<div class="well nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a class="ajax-link" href="<?php echo base_url();?>"><i class="icon-home"></i><span class="hidden-tablet"> Dashboard</span></a></li>
                                                ...
                                                <li><a class="ajax-link" href="<?php echo base_url();?>index.php/guru"><i class="icon-eye-open"></i><span class="hidden-tablet"> GURU</span></a></li>
				...
				<ul class="breadcrumb">
					<li>
						<a href="<?php echo base_url();?>">Home</a> <span class="divider">/</span>
                                        ...
                                        <li>
						<a href="<?php echo base_url();?>index.php/guru">GURU</a> <span class="divider">/</span>
					</li>
			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-mail-alt"></i> Tambah Tenaga Pendidik</h2>
						<div class="box-icon">
