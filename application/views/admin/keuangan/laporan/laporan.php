...
<head>
	...
	<link href="<?php echo base_url();?>style/css/bootstrap-cerulean.css" rel="stylesheet">
        <link href="<?php echo base_url();?>style/css/jtable/metro/darkorange/jtable.min.css" rel="stylesheet">
	<style type="text/css">
	  body {
		padding-bottom: 40px;
	  }
	...
	<!-- topbar ends -->
		...
		<div class="row-fluid">
			...
			<div>
				<ul class="breadcrumb">
					<li>
						...
						<h2><i class="icon-down"></i> DOWNLOAD LAPORAN BERDASARKAN FILTER</h2>
						<div class="box-icon">
                                ...
                                <div class="box-content">
                                    ...
                                    <div class="span12">
                                        <div class="span2">
                                            Awal  <input type="text" class="input-xsmall datepicker" id="min">
                                        </div>
                                        <div class="span2"></div>
                                        <div class="span2">
                                            Akhir  <input type="text" class="input-xsmall datepicker" id="max">
                                        </div>
			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-mail-alt"></i> LAPORAN PEMBAYARAN</h2>
						<div class="box-icon">
                                                
							<a href="<?php echo base_url();?>index.php/laporan/download" class="btn btn-round"><i class="icon-arrow-down"></i></a>
