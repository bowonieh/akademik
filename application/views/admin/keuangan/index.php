...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var no = 1;
        $('#tagihanContainer').jtable({
            title: 'ITEM JENIS BIAYA TAGIHAN',
            
            actions: {
                listAction: '<?php echo base_url();?>index.php/tagihan/ambil',
                createAction: '<?php echo base_url();?>index.php/tagihan/create',
                updateAction: '<?php echo base_url();?>index.php/tagihan/update',
                deleteAction: '<?php echo base_url();?>index.php/tagihan/delete'
            },
            fields: {
                id_tagihan: {
                    key: true,
