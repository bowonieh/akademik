...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var no = 1;
        $('#bayarContainer').jtable({
            title: 'Setoran Siswa',
            
            actions: {
                listAction: '<?php echo base_url();?>index.php/pembayaran/listall',
                createAction: '<?php echo base_url();?>index.php/pembayaran/create',
                updateAction: '<?php echo base_url();?>index.php/pembayaran/update',
                deleteAction: '<?php echo base_url();?>index.php/pembayaran/delete'
            },
            fields: {
                id_pembayaran: {
                    key: true,
                ...
                id_tagihan:{
                    title:'Nama Tagihan',
                    options: '<?php echo base_url();?>index.php/pembayaran/gettagihan',
                    list:false
                },
                keterangan:{
                    title: 'KET',
