			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2>Tambah Setoran Tagihan Siswa</h2>
						<div class="box-icon">
						  ...
						  <fieldset>
							...
							<div class="control-group">
							  ...
							  <div class="controls">
                                                                ...
                                                                <input type="text" class="span4" id="nama_siswa"  >
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								<input type="text" class="input-xlarge datepicker" id="tanggal_bayar" value="<?php echo date('Y-m-d');?>">
							  </div>
							</div>
                                                      <div class="control-group">
							  <label class="control-label" for="jumlah_bayar">Jumlah Bayar</label>
							  <div class="controls">
								<input type="text" class="input-xlarge" id="jumlah_bayar">
							  </div>
							</div>
                                                        <div class="control-group">
							  <label class="control-label" for="date01">Tagihan</label>
							  <div class="controls">
								<?php echo form_dropdown('id_tagihan', $tagihan,'','id="id_tagihan"');?>
							  </div>
							</div>
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								<textarea class="cleditor" id="keterangan" rows="2"></textarea>
							  </div>
							</div>
							<div class="form-actions">
							  <button id="btnTambah" data-url="<?php echo base_url();?>index.php/pembayaran/aksitambah" class="btn btn-primary">Save changes</button>
...
<script type='text/javascript'>
  var site = "<?php echo base_url();?>";
   ...
   $(document).ready(function(){
    $('#btnTambah').live('click',function(a){
        a.preventDefault();
        $('.alert').hide();
