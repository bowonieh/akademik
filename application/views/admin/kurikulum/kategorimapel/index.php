...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var no = 1;
        $('#rkatmapelContainer').jtable({
            title: 'KATEGORI MATA PELAJARAN',
            
            actions: {
                listAction: '<?php echo base_url();?>index.php/kategorimapel/ambil',
                createAction: '<?php echo base_url();?>index.php/kategorimapel/create',
                updateAction: '<?php echo base_url();?>index.php/kategorimapel/update',
                deleteAction: '<?php echo base_url();?>index.php/kategorimapel/delete'
            },
            fields: {
                id_katmapel: {
                    key: true,
                ...
                kategori:{
                title:'KATEGORI MATPEL',
                width:'20%'
                }
                
            }
        });
        $('#rkatmapelContainer').jtable('load');
    });
</script>
</html>
