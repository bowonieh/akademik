                                                ...
                                                <?php if(empty($isi)){
                                                  ...
                                                  ?>
                                                    ...
                                                    <tbody>
                                                      ...
                                                      <tr>
                                                          <td><?php echo $no++;?></td>
                                                          <td class="center"><?php echo $d->matpel;?></td>
                                                          <td class="center"><?php echo $d->kategori;?></td>
                                                          <td class="center">
                                                              
                                                              
									<a class="btn btn-primary" href="<?php echo base_url();?>index.php/komdasar/mapel/<?php echo $d->id_matpel;?>">
