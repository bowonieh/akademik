					...
					<div class="box-content">
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <tbody>
                                                      ...
                                                      <tr>
                                                          <td><?php echo $no++;?></td>
                                                          <td class="center"><?php echo $d->title;?></td>
                                                          <td class="center"><?php echo $d->start;?></td>
                                                          <td class="center"><?php echo $d->end;?></td>
                                                          <td class="center"><?php echo $d->isi;?></td>
                                                          <td class="center">
                                                              
                                                              <a data-toggle="modal" href="#" data-href="<?php echo base_url();?>index.php/event/viewdetil/<?php echo $d->id_event;?>" class="btn btn-primary">Lihat</a>
									...
									<a class="btn btn-danger delete" href="<?php echo base_url();?>index.php/event/hapus/<?php echo $d->id_event;?>" data-confirm="Hapus Data?">
