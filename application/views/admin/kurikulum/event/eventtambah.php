			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-mail-alt"></i> Tambah Event</h2>
						<div class="box-icon">
                                                        <a href="<?php echo base_url();?>index.php/event/tambah" class="btn btn-round"><i class="icon-plus"></i> </a>
						...
						<div class="tambahEvent">
							<form class="form-horizontal">
							  ...
							  <div class="controls">
                                                                ...
                                                                <input type="text" class="span4" id="title"  >
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								<input type="text" class="input-xlarge datepicker" id="start" value="<?php echo date('Y-m-d');?>">
							  </div>
							</div>
							<div class="control-group">
							  <label class="control-label" for="date01">Tanggal Selesai</label>
							  <div class="controls">
								<input type="text" class="input-xlarge datepicker" id="end" value="<?php echo date('Y-m-d');?>">
							  </div>
							</div>
							
							<div class="control-group">
							  <label class="control-label" for="keterangan">Detil Event</label>
							  <div class="controls">
								<textarea class="cleditor" id="isi" rows="2"></textarea>
							  </div>
							</div>
							<div class="form-actions">
							  <button id="btneventTambah" data-url="<?php echo base_url();?>index.php/event/aksitambah" class="btn btn-primary">Simpan</button>
...
$(document).ready(function(){
    $('#btneventTambah').live('click',function(a){
        a.preventDefault();
        $('.alert').hide();
        ...
        success: function(response) {
           ...
           location.reload('<?php echo base_url();?>index.php/event');
