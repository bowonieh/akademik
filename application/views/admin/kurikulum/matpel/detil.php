			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-mail-alt"></i> Detil Mata Pelajaran <?php echo $mapel->nama_matpel;?></h2>
						<div class="box-icon">
            ...
            <div class="row-fluid">
                <div class="span4">
                   <!--  <img src="assets/img/250x250.png" class="img-rounded img-responsive" /> -->
                    ...
                    <label>Nama Mata Pelajaran</label>
                     <span class="isian"><?php echo $mapel->nama_matpel;?></span>
                    <hr>
                    <label>Guru Pengampu</label>
                    <span class="isian"><?php echo $mapel->nama_guru;?></span>
                    <hr>
                ...
                <div class="span6">
                    ...
                    <div class="form-group span4">
                        ...
                        <span class="isian"><?php echo $siswa;?></span>
                    	<hr>
