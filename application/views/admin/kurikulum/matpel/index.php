...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var no = 1;
        $('#mapelContainer').jtable({
            title: 'KATEGORI MATA PELAJARAN',
            
            actions: {
                listAction: '<?php echo base_url();?>index.php/mapel/ambil',
                createAction: '<?php echo base_url();?>index.php/mapel/create',
                updateAction: '<?php echo base_url();?>index.php/mapel/update',
                deleteAction: '<?php echo base_url();?>index.php/mapel/delete'
            },
            fields: {
                id_matpel: {
                    key: true,
                ...
                id_katmapel:{
                title:'ID KATEGORI MAPEL',
                width:'10%',
                options: '<?php echo base_url();?>index.php/mapel/getkatmapel',
                list:false
