	...
	<script src="<?php echo base_url();?>style/js/jquery-1.7.2.min.js"></script>
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                //$("#hasilRaport").hide();
               $("#btnRaport").click(function(event){
...
<!-- header -->
  ...
  <div id="kontenbody">
   ...
   <div class="map">Siswa> Raport</div>
   ...
   <div class="span8">  
       ...
       <div class="form-horizontal">
           <div class="control-group">
               <label class="control-label">Pilih Tahun Ajaran</label>
               <div class="controls">
           ...
           <div class="form-actions">
               <div class="action"><button class="btn btn-primary" id="btnRaport" href="<?php echo base_url();?>index.php/raport/get">Lihat</button></div>
           </div>
       </div>
       
           <div class="jumbotron" id="hasilRaport"></div>
