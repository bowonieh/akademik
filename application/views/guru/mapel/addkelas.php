...
<!-- header -->
  ...
  <div id="kontenbody">
   ...
   <div class="span6">  
       ...
       <p class="judul">4.4 TAMBAH KELAS KE MATA PELAJARAN <?php echo strtoupper($matpel->nama_matpel);?></p>
       <p class="hrnya"></p>
       <table class="table FORM_tabel">
           <tr class="FORM_tabelrow">
               ...
               <td>:</td>
               <td>
                   <?php echo $matpel->nama_matpel;?>
                   
                   <?php echo form_hidden('id_matpelguru', $matpel->id_matpelguru,'id_matpelguru');?>
               </td>
           </tr>
           ...
           <tr class="FORM_tabelrow1">
               ...
               <td>:</td>
               <td>
                   <?php $kelas['#'] = 'Please Select'; ?>
                       <?php echo form_dropdown('id_kelas', $kelas, '#', 'id="id_kelas"'); ?></td>
           </tr>
           <tr class="FORM_tabelrow">
               <td></td>
               <td></td>
