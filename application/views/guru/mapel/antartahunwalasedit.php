...
<!-- header -->
  ...
  <div id="kontenbody">
   ...
   <div class="map">Guru > walas > Antar Tahun</div>
...
<br>
       ...
       <div>
				<div class="box-content">
						  ...
						  <fieldset>
							...
							<div class="control-group">
							  <label class="control-label" for="keterangan">Nilai Antar Mapel</label>
							  <div class="controls">
							  	<input type="hidden" id="id_tahun" value="<?php echo $th;?>"/>
							  	<input type="hidden" id="id_antarmapel" value="<?php echo $dtl->id_antarmapel;?>"/>
							  	<input type="hidden" id="nis" value="<?php echo $dtl->no_induk;?>"/>
								<textarea class="cleditor" id="nilai" rows="2"><?php echo $dtl->nilai;?></textarea>
							  </div>
							</div>
							<div class="form-actions">
							  <button id="btnEditAntarMapel" data-url="<?php echo base_url();?>index.php/walas/antarmapeledit" class="btn btn-primary">Simpan</button>
  ...
  <!-- jQuery -->
	...
	$(document).ready(function(){
	    $('#btnEditAntarMapel').live('click',function(a){
	        a.preventDefault();
	        //$('.alert').hide();
	        ...
	        var form_data = {
	            ...
	            id_antarmapel  	: $('#id_antarmapel').val(),
	            ajax			: true
	        };
	        $.ajax({
	        type: "POST",
