...
<br>
				...
				<div class="box-content">
						  ...
						  <fieldset>
							...
							<div class="control-group">
							  ...
							  <div class="controls">
							   <input type="hidden" id="id_absen" value="<?php echo $dtl->id_absen;?>"/>
							  	<input type="hidden" id="id_tahun" value="<?php echo $th;?>"/>
							  	<input type="hidden" id="nis" value="<?php echo $dtl->no_induk;?>"/>
								<?php echo form_input('sakit',$dtl->sakit,'id="sakit" class="input-small"')?>
							  </div>
							</div>
							<div class="control-group">
							  ...
							  <div class="controls">
								...
								<?php echo form_input('tanpa_keterangan',$dtl->tanpa_keterangan,'id="tanpa_keterangan" class="input-small"')?>
							  </div>
							</div>
							<div class="control-group">
							  ...
							  <div class="controls">
								...
								<?php echo form_input('ijin',$dtl->ijin,'id="ijin" class="input-small"')?>
							  </div>
							  
							</div>
							<div class="form-actions">
							  <button id="btnEditAbsensi" data-url="<?php echo base_url();?>index.php/walas/absensiedit" class="btn btn-primary">Simpan</button>
  ...
  <!-- jQuery -->
	...
	$(document).ready(function(){
	    $('#btnEditAbsensi').live('click',function(a){
	        a.preventDefault();
	        //$('.alert').hide();
	        ...
	        success: function(response) {
	           ...
	           //setTimeout(function(){window.location.replace("<?php echo base_url();?>index.php/walas");},9000);
				...
				}else if(response === 'BukanAngka'){
					new PNotify({
		                   title: 'Error',
		                   type: 'error',
		                   text: 'Gagal Menyimpan (Hanya Dijinkan Memasukkan Angka)'
		               });
