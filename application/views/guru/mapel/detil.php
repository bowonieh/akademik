...
<!-- header -->
  ...
  <div id="kontenbody">
   ...
   <div class="span6">  
       ...
       <p class="judul">DETIL MATA PELAJARAN <?php echo $mapel->nama_matpel;?></p>
       <p class="hrnya"></p>
       ...
       <div class="row-fluid">
				...
				<div class="span12">
					...
					<span class="notification"><?php echo $stat;?></span>
				</a>
                                    <a data-rel="tooltip" title="." class="well span6 top-block" href="#">
					<span class="icon32 icon-color icon-star-on"></span>
					<div>Guru Mapel</div>
					<div><?php echo $namaguru->nama_guru;?></div>
       ...
       <div class="span8">
						...
						<table>
							<tbody>
								<tr>
									<td>Nama Mapel</td>
									<td><?php echo $mapel->nama_matpel;?></td>
								</tr>
								<tr>
									<td>Kategori Matpel</td>
									<td><?php echo $mapel->kategori;?></td>
								</tr>
								<tr>
									<td>Tahun Ajar</td>
									<td><?php echo $mapel->tahun;?></td>
								</tr>
