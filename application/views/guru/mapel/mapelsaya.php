...
<!-- header -->
  ...
  <div id="kontenbody">
   ...
   <div class="map">Guru > MAPEL SAYA</div>
   
   
 
   <div class="span9">  
       
       <p class="judul">DAFTAR MATA PELAJARAN</p>
       <p class="hrnya"></p>
       <p><a href="<?php echo base_url();?>index.php/mapelsaya/tambah"><button class="btn btn-primary"><i class="icon-plus icon-white"></i>TAMBAH</button>  <button class="btn btn-danger">HELP</button></a></p>
   <table class="table table-bordered table-condensed table-hover table-striped bootstrap-datatable datatable">
       ...
       <tbody>
           ...
           <tr>
               ...
               <a href="<?php echo base_url();?>index.php/mapelsaya/edit/<?php echo $d->id_matpelguru;?>"><button class="btn btn-primary"><i class="icon-white icon-edit"></i>  EDIT DATA</button></a>
