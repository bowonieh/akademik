...
$(document).ready(function() {
$('.alert').hide();
$("#editMapel").click(function(event){
     //alert("Hapus?");
     ...
     id_matpelguru : $('#id_matpelguru').val(),   
...
<!-- header -->
  ...
  <div id="kontenbody">
   ...
   <div class="span6">  
       ...
       <p class="judul">4.3 EDIT MATA PELAJARAN</p>
       <p class="hrnya"></p>
       <table class="table FORM_tabel">
           <tr class="FORM_tabelrow">
               ...
               <td>:</td>
               <td>
               		<?php echo form_hidden('id_matpelguru',$mapel->id_matpelguru,'id_matpelguru');?>
                   <?php $kat_mapel['#'] = 'Please Select'; ?>
                   
                   <?php echo form_dropdown('id_katmapel', $kat_mapel, $mapel->id_katmapel, 'id="kat_mapel"'); ?>
               </td>
           </tr>
           ...
           <tr class="FORM_tabelrow1">
               ...
               <td>
                   <?php $mapelkuri['#'] = 'Please Select'; ?>
                       <?php echo form_dropdown('id_matpel', $mapelkuri, $mapel->id_matpel, 'id="mapelkuri"'); ?></td>
           </tr>
           ...
           <tr class="FORM_tabelrow">
               ...
               <td>:</td>
               <td><?php echo form_dropdown('id_tahun', $tahun, $mapel->id_tahun, 'id="id_tahun"'); ?></td>
           </tr>
           <tr class="FORM_tabelrow1">
               <td>NAMA MATA PELAJARAN</td>
               <td>:</td>
               <td><?php echo form_input('nama_matpel',$mapel->nama_matpel,'class="input input-large" id="nama_matpel"');?></td>
           </tr>
           <tr class="FORM_tabelrow">
               <td></td>
               <td></td>
               <td><button class="btn btn-primary" id="editMapel" href="<?php echo base_url();?>index.php/mapelsaya/aksiedit">SIMPAN</button></td>
