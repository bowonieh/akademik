...
$('.alert').hide();
$("#tambahPendidikan").click(function(event){
     //alert("Hapus?");
     ...
     var form_data = {
     id_rpendidikan : $('#id_rpendidikan').val(),   
     lembaga_pendidikan : $('#lembaga_pendidikan').val(),
     thn_mulai : $('#thn_mulai').val(),
...
<!-- header -->
  ...
  <div id="kontenbody">
   ...
   <div class="map">Guru > <a href="<?php echo base_url();?>index.php/pendidikan">Riwayat Pendidikan</a></div>
   
   
 
   <div class="span6">  
       
       <p class="judul">2.3 TAMBAH RIWAYAT PENDIDIKAN</p>
       <p class="hrnya"></p>
       <table class="table FORM_tabel" id="tabelPendidikan">
           <tr class="FORM_tabelrow">
               ...
               <td>
                   ...
                   <?php echo form_dropdown('id_rpendidikan', $jenjang, '#', 'id="id_rpendidikan"'); ?>
           ...
           <tr class="FORM_tabelrow1">
               ...
               <td>
                   ...
                   <?php echo form_input('lembaga_pendidikan','','class="input input-large" id="lembaga_pendidikan"');?>
           </tr>
           ...
           <tr class="FORM_tabelrow">
               <td>TAHUN MULAI</td>
               <td>:</td>
               <td><?php echo form_input('thn_mulai','','class="input input-large" id="thn_mulai"');?></td>
           </tr>
           <tr class="FORM_tabelrow1">
               <td>TAHUN LULUS</td>
               <td>:</td>
               <td><?php echo form_input('thn_lulus','','class="input input-large" id="thn_lulus"');?></td>
           </tr>
           
           <tr class="FORM_tabelrow">
               <td></td>
               <td></td>
               <td><button class="btn btn-primary" id="tambahPendidikan" href="<?php echo base_url();?>index.php/pendidikan/aksitambah">SIMPAN</button></td>
