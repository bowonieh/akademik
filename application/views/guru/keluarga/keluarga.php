...
<!-- header -->
  ...
  <div id="kontenbody">
   ...
   <div class="map">Guru > Keluarga</div>
   ...
   <div class="span6">  
       ...
       <p class="hrnya"></p>
       <p><a href="<?php echo base_url();?>index.php/keluarga/tambah"><button class="btn btn-primary"><i class="icon-plus icon-white"></i>TAMBAH</button></a></p>
