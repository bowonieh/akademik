...
| -------------------------------------------------------------------*/
	...
	$config['img_path'] = '/img/berita'; // Relative to domain name
	$config['upload_path'] = $_SERVER['DOCUMENT_ROOT'] . $config['img_path']; // Physical path. [Usually works fine like this]
	//$config['upload_path'] = $config['base_url'] . $config{'img_path'];
	//$config['upload_path'] = 'C:\xampp\htdocs\sekolah-2\img\berita';
/*-------------------------------------------------------------------
| 
