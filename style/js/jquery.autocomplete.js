...
(function (factory) {
    ...
    function Autocomplete(el, options) {
        var noop = function () { },
            ...
            defaults = {
                ...
                containerClass: 'suggestion-list',
                tabDisabled: false,
                dataType: 'text',
    ...
    Autocomplete.prototype = {
        ...
        initialize: function () {
            ...
            that.suggestionsContainer = Autocomplete.utils.createNode('<div class="' + options.containerClass + ' modal" style="position: auto; display: none;"></div>');
