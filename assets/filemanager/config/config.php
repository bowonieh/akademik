...
//    |   |   |   |   |- plugin.min.js
$base_url = 'http://localhost:8087/sekolah-2';  // base url (only domain) of site (without final /). If you prefer relative urls leave empty
$upload_dir = $base_url.'/img/berita/'; // path from base_url to base of upload folder (with start and final /)
$current_path = '../../img/berita/'; // relative path from filemanager folder to upload folder (with final /)
