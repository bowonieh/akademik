...
function cek_username(){
        ...
        if(username != ""){
            $.ajax({
                url: "../profil/checkusername", //arahkan pada proses_tambah di controller member
                ...
                success: function(msg){
                    ...
                    if(msg==1){
                        ...
                        $("#pesan_username").css("color","#fc5d32");
                        $("#username").css("border-color","#fc5d32");
                        $("#pesan_username").html("Hanya boleh menggunakan huruf dan angka.");
                        $("#fsubmit").prop("disabled",true);
                        error = 1;
                    }
                    else{
    ...
    //Chart menggunakan jchartfx
$("#rkpmapel").ready(function()
	{
		...
		$.ajax({
         ...
         data: "userid" ,  
			...
			title.setText("Jumlah Siswa Per Kelas");
			titles.add(title);
            ...
            var divHolder = document.getElementById('prmapel');

        chart1.create(divHolder);           

        });   
});
//chart rekap kelas per jurusan
$("#rkpjurkelas").ready(function()
	{
...
//PopulateBrowserUsage(chart1);
			...
			field1.setName("nmjurusan");
			field1.setUsage(cfx.FieldUsage.Label);
			var field2 = new cfx.FieldMap();
			field2.setName("jmlkelas");
			field2.setUsage(cfx.FieldUsage.Value);
			...
			title.setText("Jumlah kelas per program keahlian");
			titles.add(title);
            ...
            var divHolder = document.getElementById('rkpjurkelas');
